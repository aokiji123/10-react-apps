...
const choices = [
  { id: 1, name: 'rock', components: Rock, losesTo: 2 },
  { id: 2, name: 'paper', components: Paper, losesTo: 3 },
  { id: 3, name: 'scissors', components: Scissors, losesTo: 1 },
]
...
const App = () => {
  ...
  return (
    <div className="app">
      ...
      { gameState && (
        <div className={`game-state win ${gameState}`}>
          <div>
